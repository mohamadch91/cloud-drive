                        ...
                        <div className="Header_search" id="search">
                            <Tooltip title="Search" enterDelay={500} size="small">
                                <IconButton aria-label="serach"
                                            sx={{width: '40px', height: '40px', marginTop: '0.5%', marginLeft: '0.5%'}}>
                                    <SearchIcon sx={{width: '25px', height: '25px'}}/>
                                </IconButton>
                            </Tooltip>
                            {/* know on focus on element */}

                            <input type="text" placeholder="Search in Drive" id="search_input" onFocus={Search}
                                   onBlur={Search_out}/>
                    ...
                    <Grid item xs={5} md={2} sm={2}>
                        ...
                        <div className="Header_right">
                            ...
                            <IconButton
                                ...
                                sx={{width: '40px', height: '40px', marginTop: '0.5%', marginLeft: '25px'}}
